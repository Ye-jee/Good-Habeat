...
public class DietFragment_vitamin_mineral extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_diet_vitamin_mineral, container, false);

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.vitaminMineralDiet_container);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ArrayList<CategoryDietData> category_diet_data = new ArrayList<>();

        String url = "http://10.0.2.2:3000/category_diet/vitamin";
        RequestQueue requestQueue = Volley.newRequestQueue(getContext());
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                //System.out.println("비타민 response : " + response);
