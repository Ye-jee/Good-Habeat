...
public class MenuWeekRecyclerViewAdapter extends RecyclerView.Adapter<MenuWeekRecyclerViewAdapter.ViewHolder> {
    ArrayList<MenuWeekData> data;

    public MenuWeekRecyclerViewAdapter(ArrayList<MenuWeekData> data) { this.data = data; }
    ...
    @Override
    public void onBindViewHolder(@NonNull MenuWeekRecyclerViewAdapter.ViewHolder holder, int position) {
