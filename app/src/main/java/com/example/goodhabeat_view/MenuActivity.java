...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<com.example.goodhabeat_view.MenuDayData> menu_day_data = new ArrayList<>();
        ...
        today_bf = (RadioButton) findViewById(R.id.today_breakfast);
        today_lc = (RadioButton) findViewById(R.id.today_lunch);
        today_dn = (RadioButton) findViewById(R.id.today_dinner);
        ...
        if (todayDate.getText().toString().equals("2022.08.28")) {
            ...
            for (int i = 0; i < 3; i++) {
                com.example.goodhabeat_view.MenuDayData dataSet = new com.example.goodhabeat_view.MenuDayData(menu_pic_id[i], menu_name[i], menu_text[i]);
