...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryText_lowFat = (TextView) findViewById(R.id.main_lowFat_category);
        ...
        categoryText_lowFat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
