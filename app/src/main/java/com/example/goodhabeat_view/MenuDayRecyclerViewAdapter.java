...
public class MenuDayRecyclerViewAdapter extends RecyclerView.Adapter<MenuDayRecyclerViewAdapter.ViewHolder> {
    ...
    SharedPreferences preferences_check;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            eat_done.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    // 선택되었는지 확인
                    if(data.get(position).getEat_check() == null) {
                        check = "non-checked";
                    } else {
                        check = data.get(position).getEat_check();
                    }

                    AlertDialog.Builder dlg = new AlertDialog.Builder(itemView.getContext());
                    if(check.equals("non-checked")){
                                    ...
                                    public void onResponse(String response) {
                                        try{
                                            ...
                                            if(response.equals("input")){
                                                ...
                                                data.get(position).setEat_check("checked");
